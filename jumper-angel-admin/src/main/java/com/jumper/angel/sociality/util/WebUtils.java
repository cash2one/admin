...
public abstract class WebUtils {
	...
	public static String doJsonPost(String url, Map<String, String> params,
			int connectTimeout, int readTimeout) throws IOException {
		return doPost(url, params, DEFAULT_CHARSET, ACCEPT_JSON,
	 ...
	 * @throws IOException
	 */
	public static String doDelete(String url, int connectTimeout,
			int readTimeout) throws IOException {
		return doDelete(url, DEFAULT_CHARSET, connectTimeout, readTimeout);
	}
	...
	public static String doPost(String url, Map<String, String> params,
			String charset, String accept, int connectTimeout, int readTimeout)
			throws IOException {
		String ctype = "application/x-www-form-urlencoded;charset=" + charset;
		String query = buildQuery(params, charset);
		byte[] content = {};
	...
	public static String doDelete(String url, String charset,
		...
		try {
			try {
				conn = getConnection(new URL(url), METHOD_DELETE, ctype);
	...
	public static String doPost(String url, String accept, String ctype,
...
//		conn.setRequestProperty("User-Agent", "aop-sdk-java");
	...
	private static HttpURLConnection getConnection(URL url, String method,
			String accept, String ctype) throws IOException {
		HttpURLConnection conn = null;
		if ("https".equals(url.getProtocol())) {
			SSLContext ctx = null;
			try {
