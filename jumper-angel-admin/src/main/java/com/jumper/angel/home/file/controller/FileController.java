package com.jumper.angel.home.file.controller;
...
import com.jumper.angel.utils.Utils;
...
public class FileController {
	...
	public FileController(){
		this.fileServerURL = ConfigProUtils.get("file_upload");
	}
	...
	public ResultMsg upload(HttpServletRequest request) {
		try {
			...
			return new ResultMsg(Status.SUCCESS, "上传成功！", response);
		} catch (Exception e) {
			logger.error("findBaby()", e);
			return new ResultMsg(Status.FAILED, "上传失败！");
		}
	}
