 ...
 */
public class ImMsgPo implements java.io.Serializable {
	...
	/** 0.待发送 1.已发送 2.已回调 3.未读 4.已读 5.回撤 */
	...
	public ImMsgPo(Long msgId, String busCode, String consultantId,
			String sendChatId, String recevrerChatId, String sendTime,
			Integer msgType, String dataId, Long dataType, String msgContent,
