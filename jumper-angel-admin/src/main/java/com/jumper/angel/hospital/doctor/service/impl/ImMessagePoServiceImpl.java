...
import com.jumper.angel.hospital.doctor.mapper.ImMessagePoMapper;
import com.jumper.angel.hospital.doctor.service.IImMessagePoService;
import com.jumper.angel.utils.Page;
@Service
public class ImMessagePoServiceImpl implements IImMessagePoService {

	@Autowired
	private ImMessagePoMapper imMessagePoMapper;
	
	/**查询咨询信息的总条数*/
	public int findMessageCount(String busCode, String sender, String recevrer,String startTime, String endTime) {
		
		return imMessagePoMapper.findMessageCount(busCode,sender,recevrer,null,null);
	}

	public List<ImMessagePo> findMessage(Page page, String busCode, String sender, String recevrer, String startTime,
		...
		Integer start = (currentPage-1)*pageSize;
		List<ImMessagePo> imMessages = imMessagePoMapper.findMessage(start,pageSize,busCode, sender, recevrer, null, null,consultantId);
		return imMessages;
	}
