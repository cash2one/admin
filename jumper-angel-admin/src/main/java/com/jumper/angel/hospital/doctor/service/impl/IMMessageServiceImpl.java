...
public class IMMessageServiceImpl implements IIMMessageService {
	...
	public List<IMMessage> findMessage(Page page, String busCode, String sender, String recevrer, String startTime,
		...
		Integer start = (currentPage-1)*pageSize;
		List<IMMessage> imMessages = IMMessageMapper.findMessage(start,pageSize,busCode, sender, recevrer, null, null,consultantId);
		return imMessages;
	}
