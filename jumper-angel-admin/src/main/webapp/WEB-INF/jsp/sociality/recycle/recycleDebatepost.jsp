...
<div class="container">
	...
	<div class="content">
		...
		<div class="tab-but">
			<ul class="tab-ul">
				<a href="${pageContext.request.contextPath}/sociality/recycleManager/recycleDebatepost" class="grey"><li class='tab_active'>帖子回收站</li></a>
				<a href="${pageContext.request.contextPath}/sociality/recycleManager/recycleComment" class="grey"><li>评论回收站</li></a>
			</ul>
		</div>
		<div class="panel">
			<table class="table">
...
<div class="showBox2">
	...
	<script src="${pageContext.request.contextPath}/media/js/sociality/recycle/recycleDebatepost.js"></script>
</body>
</html>