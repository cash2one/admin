...
<div class="container">
	...
	<div class="content">
        ...
        <div class="tab-but2">
            <ul class="tab-ul2">
                <li class="tab_active"><a href="${pageContext.request.contextPath}/sociality/reprot/debatepost/index">被举报的话题</a></li>
                <li><a href="${pageContext.request.contextPath}/sociality/reprot/comment/index">被举报的评论</a></li>
        ...
        <div style="overflow: hidden;">
            <div class="content-search-top float-l" style="width: 398px!important;">
                ...
                <div class="float-r" >
                    ...
                    <button class="search-icon float-l" id="searchReportDebatepost"></button>
                </div>
...
<script src="${pageContext.request.contextPath}/media/js/sociality/report/reportDebatepost.js"></script>
</body>
</html>