	...
	<div class="content">
        ...
        <div class="tab-but2">
            <ul class="tab-ul2">
                ...
                <li class="tab_active"><a href="${pageContext.request.contextPath}/sociality/reprot/user/index">被举报的用户</a></li>
            </ul>
        </div>
        <div style="overflow: hidden;">
            <div class="content-search-top float-l" style="width: 398px!important;">
                ...
                <div class="float-r">
                    ...
                    <button class="search-icon float-l" id="searchReportUser"></button>
                </div>
...
<script src="${pageContext.request.contextPath}/media/js/sociality/report/reportUser.js"></script>
</body>
</html>