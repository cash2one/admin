...
<body>
	...
	<div class="content">
		...
		<div class="content-search-top">
			<input class="shortinput float-l" id="keywords" placeholder="输入模块名关键词"/>
			<button class="search-icon float-l" id="searchBtn"></button>
			<div class="float-r">
				<button class="red_btn_big addOrEditQuestionClass" type="add" style="+padding: 8px 0;_padding: 8px 0;">+ 新增模块</button>
			</div>
		</div>
		<div class="panel">
			<table class="table"> 
    	...
    	<form>
    		<ul>
    			<li>
    				...
    				<input type="text" class="shortinput" id="className"/>
    			</li>
    			<li>
    				<label class="label">模块内容</label>
    			...
    			<li>
    				<span id="errorMsg" style="color:red;margin-left:60px;"></span>
    			</li>
    		</ul>
    	</form>
	</div>
	
	<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/encyclopedia/question_class.js"></script>
</body>
</html>